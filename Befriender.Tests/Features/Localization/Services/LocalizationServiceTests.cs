...
namespace Befriender.Tests.Features.Localization.Services;
...
public class LocalizationServiceTests {
    ...
    public void LocalizationService_Translate_FormatsStringWithArguments() {
        ...
        // Act
        var result = service.Translate("Welcome_Message", "Almeris", "Befriender");

        // Assert
        Assert.Equal("Welcome Almeris to Befriender!", result);
    }
}