...
namespace Befriender.Tests.Features.Greeting.Services;
...
public class GreetingServiceTests {
    ...
    public void GreetingService_SayHello_PrintsToChat() {
        ...
        mockLocalizationService.Translate("Greeting_Message").Returns("Hello World from Befriender!");
        ...
        mockChatGui.Received(1).Print("Hello World from Befriender!");
    }
}