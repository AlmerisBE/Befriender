...
public class ListTab : ITab {
    ...
    public ListTab(IFriendRepository friendRepository, FriendListTableComponent tableComponent, FriendProfilePanelComponent profilePanelComponent, FriendStatusBarComponent statusBarComponent) {
    ...
    public void Draw() {
        ...
        // Reset refresh flag after table processes it
        this.forceRefresh = false;

        // 2. Draw Side Panel Component
