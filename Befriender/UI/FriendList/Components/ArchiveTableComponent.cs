...
public class ArchiveTableComponent {
    ...
    public ArchiveTableComponent(ILocalizationService loc, IThemeService themeService, IFriendActionService actionService) {
        this.loc = loc;
        this.themeService = themeService;
        this.actionService = actionService;
    }

    public void Draw(float tableWidth, float footerHeight, IReadOnlyList<FriendProfile> archivedFriends, FriendProfile? selectedFriend, Action<FriendProfile?> onRowSelected) {
